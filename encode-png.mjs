...
// from https://github.com/kyriosli/YAPD/blob/master/src/encoder/png_encode.js
// see https://github.com/denoland/deno_std/issues/410
...
export function encode(arr, width, height, options) {
    // read canvas data
    // init worker
